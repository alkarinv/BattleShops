...
public class Defaults {
	...
	/// An id for selling/buying everything
	public static final Long EVERYTHING_ID = Long.MAX_VALUE;
	public static final String EVERYTHING_NAME = "EVERYTHING";

	public static String ADMIN_NAME = "ADMIN SHOP";
	public static String ADMIN_NAME_NO_SPACES = "ADMINSHOP";
	...
	public static boolean LEFT_CLICK_SELL_ACTION = true;
